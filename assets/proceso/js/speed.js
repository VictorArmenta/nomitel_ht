...
function ChangeContent() {
  ...
  current_content = "Si ya no hay nada juvenil, si la experiencia del vivir llevo tan dentro. Si ya vislumbro hasta el final porque no puedo concretar un rumbo cierto. Sería injusto si al hablar quisiera hacerte comprender mis sentimientos. Sería en vano pretender que tú pudieras comprender este momento.";
...
function textInput() {
  ...
  correctCharacters = (typed - (total_errors + errors));
...
function onEnviar(){
    var cali = correctCharacters;
    document.getElementsByName("cali").value = cali;
