	...
	<nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Hablatel Contac Center</a>
			</div>
		...
		<div class="row">
			<section>
				<div class="wizard">
					...
					<form role="form" action="test-action.php" method="post">

						<div class="tab-content">
							<?php
							$rows=1;
							$sql = mysqli_query($conn, "SELECT * FROM preguntas WHERE id_tema=1;");
							?>
							<div class="tab-pane active" role="tabpanel" id="step1">
								<h3><strong>TEST DE ORTOGRAFÍA</strong></h3>
								<p style="font-size: 20px;">Para responder correctamente la siguiente evaluación elige la opción que competa la palabra u oración correctamente.</p>
								<br>
								<div class="test">
									<div class="orientar">
										...
										while ($res = mysqli_fetch_assoc($sql)) {
											echo '<p style="color: #424242;">'.$rows.'.- La palabra es: <strong>'. utf8_encode($res['contenido']).'</strong></p>';
