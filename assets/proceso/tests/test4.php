		...
		<div class="row">
			<section>
				<div class="wizard">
					...
					<form role="form" action="test-action4.php" method="post">

						<div class="tab-content">
							<?php
							$rows=1;
							$sql = mysqli_query($conn, "SELECT * FROM preguntas WHERE id_tema=3;");
							?>
							<div class="tab-pane active" role="tabpanel" id="step1">
								<h3><strong>TEST DE PSICOMETRIA</strong></h3>
								<p style="font-size: 20px;">Responde las siguientes preguntas, eligiendo una de las alternativas.</p>
								<br>
								<div class="test">
									<div class="orientar">
										...
										while ($res = mysqli_fetch_assoc($sql)) {
											...
											$respuestas = mysqli_query($conn, "SELECT * FROM respuestas WHERE id_pregunta = 0");
