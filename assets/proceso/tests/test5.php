...
<body>
	...
	<div class="container" style="width: 1100px;">
		<div class="row">
			<section>
				<div class="wizard" style="height: 850px;">
					...
					<form role="form" action="test-action5.php" method="post">

						<div class="tab-content">
						    <?php
							$rows=1;
							$sql = mysqli_query($conn, "SELECT * FROM preguntas WHERE id_tema=4;");
							?>
							<div class="tab-pane active" role="tabpanel" id="step1">
								<h3><strong>TEST DE ESCUCHA ACTIVA</strong></h3>
								<p style="font-size: 20px;">Reproduce el audio, y responde las siguientes preguntas. <br><strong>(1 reproducción)</strong></p>
								<br>
                                <audio id="audio">
                                  <source src="../audios/AUDIO.mp3" type="audio/mpeg">
                                  Tu navegador no soporta este audio.
                                </audio>
                                <input type="button" id="boton" value="Reproducir audio" class="btn btn-primary" style="font-size: 16px;">
                                <br>
                                <br>
